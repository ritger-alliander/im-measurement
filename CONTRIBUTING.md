# Contributing to im-measurement

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-measurement. These guidelines are not strict rules.
...
The im-measurement team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-measurement technical leads
...
[issues]: https://github.com/ritger-alliander/im-measurement/issues/
[pulls]: https://github.com/ritger-alliander/im-measurement/pulls/
